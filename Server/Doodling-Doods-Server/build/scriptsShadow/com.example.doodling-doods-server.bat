...
set CLASSPATH=%APP_HOME%\lib\com.example.doodling-doods-server-all.jar

@rem Execute com.example.doodling-doods-server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COM_EXAMPLE_DOODLING_DOODS_SERVER_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%COM_EXAMPLE_DOODLING_DOODS_SERVER_EXIT_CONSOLE%" exit 1
exit /b 1
